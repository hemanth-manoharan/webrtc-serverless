...
async function run() {
  ...
  let { generateKeyPair, sign, exportKeyJWK, importPrivateKeyJWK } = await import('./crypto.js');

  let { app } = await import('./bb-models.js');

  let { ChatListView, MessageListView, UserInfoView, PeerJSInfoView } = await import('./components.js');
